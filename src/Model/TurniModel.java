...
public class TurniModel {
	...
	String Nome_Turno; 	// id turno
	String Lunedi; 		// i campi per i giorni possono avere 3 valori: MATTINA, POMERIGGIO, RIPOSO
	String Martedi;		// MATTINA: 8-13
	String Mercoledi;	// POMERIGGIO: 15-20
	String Giovedi;		// RIPOSO
	String Venerdi;
	String Sabato;

	public TurniModel (String Nome_Turno, String Lunedi, String Martedi, String Mercoledi, String Giovedi, String Venerdi, String Sabato) {
	...
	// + get (per visualizzare) e set (non posso modificare il nome)
