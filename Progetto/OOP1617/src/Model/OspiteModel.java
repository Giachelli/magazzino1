...
public class OspiteModel {
	...
	public OspiteModel(String nome, String marca, Float prezzo,Float prezzo_offerta,Integer qta,
	...
	public OspiteModel(String nome,String settore){
        this.nome = nome;
        this.settore=settore;
